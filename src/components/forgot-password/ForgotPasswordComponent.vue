<style lang="" src="./ForgotPasswordComponent.css"></style>
  <template>
    ...
    <div class="background-gif" >
      <video src="../../assets/videos/logo-main.mp4" muted autoplay loop ></video>
     
      
    </div>
  </template>
<script src="./ForgotPasswordComponent.ts"></script>
